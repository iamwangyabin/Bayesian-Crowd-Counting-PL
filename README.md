This project is from [Bayesian-Crowd-Counting](https://github.com/ZhihengCV/Bayesian-Crowd-Counting) project

With pytorch-lightning can support distributed training, 16-bit precision.
